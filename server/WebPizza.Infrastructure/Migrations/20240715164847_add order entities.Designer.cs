...
namespace WebPizza.Infrastructure.Migrations
{
    ...
    [Migration("20240715164847_add order entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebPizza.Core.Entities.OrderEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebPizza.Core.Entities.OrderItemEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SizePriceId");

                    b.ToTable("tbl_order_items");
                });

            modelBuilder.Entity("WebPizza.Core.Entities.OrderStatusEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebPizza.Core.Entities.OrderEntity", b =>
                {
                    b.HasOne("WebPizza.Core.Entities.OrderStatusEntity", "OrderStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("WebPizza.Core.Entities.OrderItemEntity", b =>
                {
                    b.HasOne("WebPizza.Core.Entities.OrderEntity", "Order")
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("WebPizza.Core.Entities.PizzaSizePriceEntity", "SizePrice")
                        .WithMany()
                        .HasForeignKey("SizePriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
